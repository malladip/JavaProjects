...
<div class="fieldcontain ${hasErrors(bean: subServiceTypeOtherServices, field: 'subType', 'error')} required ">
	<label for="subType">
		<g:message code="subServiceTypeOtherServices.subType.label" default="Sub Type" />
		<span class="required-indicator">*</span>
	</label>
	<g:checkBox name="subType1" checked ="${list1.contains("indian")?true:false}" value="indian"/> indian
	<g:checkBox name="subType2" checked ="${list1.contains("continental")?true:false}" value="continental"/> continental
</div>
