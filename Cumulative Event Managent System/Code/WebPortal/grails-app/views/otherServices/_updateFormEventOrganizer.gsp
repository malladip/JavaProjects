...
<div class="fieldcontain ${hasErrors(bean: subServiceTypeOtherServicesInstance, field: 'subType', 'error')} required ">
	...
	<g:checkBox name="subType1" checked ="${list1.contains("Marriage")?true:false}" value="Marriage"/> Marriage
	<g:checkBox name="subType2" checked ="${list1.contains("Birthday")?true:false}" value="Birthday"/> Birthday
	<g:checkBox name="subType3" checked ="${list1.contains("Party")?true:false}" value="Party"/> Party
	<g:checkBox name="subType4" checked ="${list1.contains("Function")?true:false}" value="Function"/> Function
</div>
