	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.idUser}">
				<li class="fieldcontain">
					<span id="idUser-label" class="property-label"><g:message code="user.idUser.label" default="Id User" /></span>
					
						<span class="property-value" aria-labelledby="idUser-label"><g:fieldValue bean="${userInstance}" field="idUser"/></span>
